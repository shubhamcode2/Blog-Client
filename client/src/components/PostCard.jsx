...
const PostCard = ({ src, userName, createdAt, content, postPicture }) => {
    return (
        <div className="bg-white rounded-xl shadow p-4 mb-4">
            <div className="flex items-center gap-4 mb-2">
                <img src={src} alt="Profile" className="w-10 h-10 rounded-full object-cover" />
                <div className="flex flex-col">
            ...
            <p className="text-gray-800 mb-2">{content}</p>
            {postPicture && (
                <img src={postPicture} alt="Post" className="w-full max-h-[400px] object-cover rounded-md" />
            )}
        </div>
    );
};
